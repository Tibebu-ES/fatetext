...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <!-- step 1 -->
            <div class="col-md-6" id="step-1" style="display:none">
                <div class="card ">
            ...
            <!-- step 2 -->
            <div class="col-md-6" id="step-2" style="display:none">
                <div class="card ">
                    <div class="card-header">
            ...
            <div class="card ">
                ...
                <div class="card-footer text-muted">
                    ...
                    <form class="form-inline">
                        ...
                        <a href="#step-final" type="button" id="answerInput" class="btn btn-primary mb-2" onclick="finish()">Answer</a>
                    </form>
                </div>
            </div>
        </div>
