...
<nav class="navbar navbar-expand-md navbar-dark bg-dark sticky-top">
    <div class="container-fluid">
        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            <li class="nav-item">
                <a href="#exampleModal" type="button" class="btn btn-outline-light" data-toggle="modal"
                   data-target="#exampleModal" onclick="getRecentGuesses()">History <i class="fa fa-history fa-"></i>
                </a>
            </li>
        </ul>
                    ...
                    <div class="row" style="float: right;">
                        <form class="form-inline">
                            <div class="input-group">
                                <input type="text" class="form-control" id="guessInput" placeholder=""
                                       onkeypress="return enterEventHandler(event)">
                                <div class="input-group-append">
                                    <button id="guessButton" class="btn btn-success" onclick="step2()" type="button">
                                        Guess
                                    </button>
                                </div>
                            </div>
                            ...
                            <form class="form-inline ">
                                <div class="input-group ">
                                    <input type="text" class="form-control" id="questionInput"
                                           onkeypress="enterEventHandler(event)">
                                    <div class="input-group-append">
                                        <button id="askButton" class="btn btn-success" onclick="step3()" type="button">
                                            Ask
                                        </button>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <a href="#" type="button" id="backButton2" class="btn  btn-md btn-warning"
                                       onclick="backToPreviousStep()">Back</a>
                                </div>
                            </form>
                        </div>
                    </div>
            ...
            <div class="card text-white bg-primary border-dark ">
                ...
                <div class="card-footer ">
                    ...
                    <div class="row" style="float: right;">
                        <form class="form-inline">
                            <div class="form-group ">
                                <input type="text" class=" form-control" onkeypress="enterEventHandler(event)"
                                       id="answerInput" placeholder="">
                                <div class="input-group-append">
                                    <button id="answerButton" class="btn btn-success" onclick="finish()" type="button">
                                        Answer
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <a href="#" type="button" id="backButton3" class="btn  btn-md btn-warning"
                                   onclick="backToPreviousStep()">Back</a>
                            </div>
                        </form>
                    </div>
        ...
        <div class="col-md-12 col-sm-12 mt-sm-12" id="step-final" style="display:none">
            <div class="card text-white bg-primary border-dark">
                <div class="card-header row">
                    ...
                    <a type="button" id="restartButton" style="float: right;" href="#"
                       class="col-md-4 btn btn-success mb-2" onclick="restart()">Play again</a>
                </div>
            </div>
        </div>
    </div>
