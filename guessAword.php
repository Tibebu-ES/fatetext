                ...
                <div class="card-footer text-muted">
                    <form class="form-inline">
                        <div class="col-md-6 d-flex">
                            ...
                            <div class="col-md-6">
                                <button type="button" id="guessButton" class="btn btn-primary mb-2" onclick="step2()">Guess</button>
                            </div>
                        </div>
                    </form>
                </div>
                ...
                <div class="card-body">
                    <form class="form-inline">
                        <div class="col-md-12 d-flex">
                            ...
                            <div class="col-md-6">
                                <a href="#step-3" type="button" id="askButton" class="btn btn-primary mb-2" onclick="step3()"> Ask</a>
                                <a href="#" type="button" id="backButton2" class="btn btn-primary mb-2" onclick="backToPreviousQuestion()">Back</a>
                            </div>
                        </div>
                    </form>
            ...
            <div class="card-footer text-muted">
                ...
                <form class="form-inline">
                    <div class="col-md-12 d-flex">
                        ...
                        <div class="col-md-6">
                            <a href="#step-final" type="button" id="answerButton" class="btn btn-primary mb-2" onclick="finish()">Answer</a>
                            <a href="#" type="button" id="backButton3" class="btn btn-primary mb-2" onclick="backToPreviousQuestion()">Back</a>
                        </div>
                    </div>
                </form>
            </div>
